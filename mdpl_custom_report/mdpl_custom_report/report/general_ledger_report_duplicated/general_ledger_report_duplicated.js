...
frappe.query_reports["General Ledger Report Updated"] = {
	filters: [
		{
			fieldname: "company",
			label: __("Company"),
		...
		// -- NEW: GST Grouping filter ----------------------------------------
		{
			fieldname: "group_by_gst",
			label: __("Group by GST No (GSTIN)"),
			fieldtype: "Check",
			default: 0,
			description: "Groups Customer GL entries by GSTIN. Customers sharing the same GST number are merged under one section.",
		},
		// -----------------------------------------------------------------------
	],
...
erpnext.utils.add_dimensions("General Ledger Report Updated", 15);
